...
model = YOLO('./anpr/best.pt')

# Load the image
image_path = "./anpr/labeled_frame/plate_cropped_2025-07-22_23-28-08.jpg"
image = cv2.imread(image_path)

# Preprocess the image (improve OCR results)
...
# Initialize PaddleOCR with Nepali + English (if supported by your model)
ocr = PaddleOCR(use_angle_cls=True, lang='ne')  # 'ne' supports Nepali characters
...
# Step 3: Run OCR using PaddleOCR
